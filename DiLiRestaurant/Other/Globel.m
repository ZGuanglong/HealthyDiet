...
+ (NSString *)getUserInfoIcon{
    NSRange range=[[DLUserInfo getUserDetail].headPhotoAdd rangeOfString:@"http" options:NSBackwardsSearch];
    if (range.location!=NSNotFound) {
        return [[DLUserInfo getUserDetail].headPhotoAdd substringFromIndex:range.location];
    }
    else
        return @"";
}
