...
@interface DLDatePickView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
    //日期存储数组
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(labelX, self.showYearView.frame.size.height/2-20/2.0, 40, 20)];
