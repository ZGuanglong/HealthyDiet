...
@property(nonatomic,copy)NSArray <DLBannarImageInfo*>*imageArr;//图片的数组
...
#pragma mark---实现类方法
+(instancetype)roundScrollViewWithFrame:(CGRect)frame imageArr:(NSArray <DLBannarImageInfo*>*)imageArr timerWithTimeInterval:(NSTimeInterval)timeInterVal imageClick:(imageClick)imgClick;
{
...
-(void)addImageView
{
    ...
    NSURL *url_center=[NSURL URLWithString:[NSString stringWithFormat:@"%@",_imageArr[_centerCurIndex].imageUrl]];
    [_centerImgView sd_setImageWithURL: url_center placeholderImage:[UIImage imageNamed:_imageArr[_centerCurIndex].imageUrl]];
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    //切换左，中，右三个位置上面的图片
    NSURL *url_left=[NSURL URLWithString:[NSString stringWithFormat:@"%@",_imageArr[_leftCurIndex].imageUrl]];
    [_leftImgView sd_setImageWithURL: url_left placeholderImage:[UIImage imageNamed:_imageArr[_leftCurIndex].imageUrl]];
    NSURL *url_center=[NSURL URLWithString:[NSString stringWithFormat:@"%@",_imageArr[_centerCurIndex].imageUrl]];
    [_centerImgView sd_setImageWithURL: url_center placeholderImage:[UIImage imageNamed:_imageArr[_centerCurIndex].imageUrl]];
    NSURL *url_right=[NSURL URLWithString:[NSString stringWithFormat:@"%@",_imageArr[_rightCurIndex].imageUrl]];
    [_rightImgView sd_setImageWithURL: url_right placeholderImage:[UIImage imageNamed:_imageArr[_rightCurIndex].imageUrl]];
